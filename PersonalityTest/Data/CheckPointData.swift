...
let checkPointData: [CheckPoint] = [
    ...
    CheckPoint(title: "透過大吼大叫讓大家遵守規則？",
    ...
    CheckPoint(title: "比較喜歡靜態還是動態的娛樂？",
    ...
    CheckPoint(title: "你確定你真的一點點感性都沒有？",
